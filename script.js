window.addEventListener('load', function () {
    ...
    class Egg {
        constructor(game) {
            ...
            this.spriteY;
            this.hatchTimer = 0;
            this.hatchInterval = 5000; //1s = 1000
    ...
    class Game {
        constructor(canvas) {
            ...
            window.addEventListener('keydown', e => {
                ...
                else if (e.key == 'r' && this.gameOver) this.restart();
            })
        }
        render(context, deltaTime) {
            ...
            if (this.score >= this.winningScore) {
                this.winLoseCondition(context);
            }

        }
        winLoseCondition(context) {
            this.gameOver = true;
            context.save();
            ...
            if (this.lostHatchlings <= 5) {
                ...
                message1 = "Bullocks!";
                message2 = "You lost! " + this.lostHatchlings + " hatchlings, don't save";
            }
            ...
            context.fillText("Final Score " + this.score + " . Press 'R' to butt heads again!",
                this.width * 0.5, this.height * 0.5 + 90);
            context.restore();
        }
